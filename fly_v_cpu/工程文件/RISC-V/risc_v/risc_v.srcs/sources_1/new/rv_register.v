module rv_register(
        ...
        input  wire               EX2REG_REG_RD_EN,//register read enable signal from ex to reg
        //operation data 0
        input  wire [4:0]          EX2REG_OP0_ADDR,//operation data0 address from ex to reg
        output wire [31:0]         REG2EX_OP0_DATA,//operation data0 from reg to ex
        //operation data 1
        input  wire [4:0]          EX2REG_OP1_ADDR,//operation data1 address from ex to reg 
        output wire [31:0]         REG2EX_OP1_DATA,//operation data1 from reg to ex         
        //write data back
        input  wire               WB2REG_REG_WR_EN,//register write enable signal from wb to reg
        input  wire [4:0]           WB2REG_RD_ADDR,//rd register address from wb to reg
        input  wire [31:0]          WB2REG_RD_DATA //rd register data from wb to reg
    );
