...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AHB_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_AHB_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_M_FIFO_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_FIFO_DEPTH" -parent ${Page_0}
