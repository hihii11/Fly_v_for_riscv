...
HD_PWD='D:/Vivado/project/CPU/RISC-V-SOC/risc-v-soc/risc-v-soc.runs/risc_v_soc_test_My_Concat_4_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc_v_soc_test_My_Concat_4_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc_v_soc_test_My_Concat_4_0_1.tcl
