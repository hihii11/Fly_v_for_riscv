...
HD_PWD='D:/Vivado/project/CPU/RISC-V-SOC/risc-v-soc/risc-v-soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc_v_soc_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc_v_soc_test_wrapper.tcl
