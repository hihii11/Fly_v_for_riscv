...
HD_PWD='D:/Vivado/project/CPU/RISC-V-SOC/risc-v-soc/risc-v-soc.runs/risc_v_soc_test_AHB_Lite_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc_v_soc_test_AHB_Lite_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc_v_soc_test_AHB_Lite_gpio_0_0.tcl
