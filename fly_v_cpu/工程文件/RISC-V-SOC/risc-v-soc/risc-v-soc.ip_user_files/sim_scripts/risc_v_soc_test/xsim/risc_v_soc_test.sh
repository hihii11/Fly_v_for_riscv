...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconcat_v2_1_1 -L blk_mem_gen_v8_4_2 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot risc_v_soc_test xil_defaultlib.risc_v_soc_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim risc_v_soc_test -key {Behavioral:sim_1:Functional:risc_v_soc_test} -tclbatch cmd.tcl -protoinst "protoinst_files/risc_v_soc_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb risc_v_soc_test.wdb xsim.dir)
