...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.risc_v_soc_test \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../bd/risc_v_soc_test/ipshared/46a6/src" \
       +incdir+"../../../../risc-v-soc.srcs/sources_1/bd/risc_v_soc_test/ipshared/46a6/src"
}
